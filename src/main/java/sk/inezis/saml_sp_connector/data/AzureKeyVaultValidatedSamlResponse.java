 ...
 */
public class AzureKeyVaultValidatedSamlResponse extends SamlResponse {
    /**
     * Private property to construct a logger for this class.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(AzureKeyVaultValidatedSamlResponse.class);
     ...
     */
    public AzureKeyVaultValidatedSamlResponse(Saml2Settings settings, HttpRequest request) throws XPathExpressionException, ParserConfigurationException, SAXException, IOException, SettingsException, ValidationError {
    ...
    private void decryptElement(Element encryptedDataElement, PrivateKey inputKey) {
        try {
			...
			*/
            ...
            AzureKeyVaultEncryptedKeyResolver encryptedKeyResolver =
                    new AzureKeyVaultEncryptedKeyResolver("http://www.w3.org/2001/04/xmlenc#aes128-cbc", inputKey);
            xmlCipher.registerInternalKeyResolver(encryptedKeyResolver);
